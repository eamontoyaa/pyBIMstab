...
The sources for pyBIMstab can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/eamontoyaa/pybimstab
.. _tarball: https://github.com/eamontoyaa/pybimstab/tarball/master
